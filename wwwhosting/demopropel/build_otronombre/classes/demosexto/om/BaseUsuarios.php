...
abstract class BaseUsuarios extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the vacunado field.
     * @var        int
     */
    protected $vacunado;
     ...
     * @return string
     */
    public function getLosApellidos()
    {
    ...
    {
        if (null === $this->vacunado) {
            return null;
        }
        $valueSet = UsuariosPeer::getValueSet(UsuariosPeer::VACUNADO);
        if (!isset($valueSet[$this->vacunado])) {
            throw new PropelException('Unknown stored enum key: ' . $this->vacunado);
        }

        return $valueSet[$this->vacunado];
    }
     ...
     * @throws PropelException - if the stored enum key is unknown.
     */
    public function getQueGenero()
    {
        if (null === $this->genero) {
            return null;
        }
        $valueSet = UsuariosPeer::getValueSet(UsuariosPeer::GENERO);
    ...
    public function setNombres($v)
    {
        ...
        if ($this->nombres !== $v) {
            $this->nombres = $v;
            $this->modifiedColumns[] = UsuariosPeer::NOMBRES;
        }
     ...
     * @return Usuarios The current object (for fluent API support)
     */
    public function setLosApellidos($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->apellidos !== $v) {
            $this->apellidos = $v;
            $this->modifiedColumns[] = UsuariosPeer::APELLIDOS;
        }
    ...
    public function setCorreo($v)
    {
        ...
        if ($this->correo !== $v) {
            $this->correo = $v;
            $this->modifiedColumns[] = UsuariosPeer::CORREO;
        }
    ...
    /**
     * Set the value of [vacunado] column.
     *
     * @param  int $v new value
     * @return Usuarios The current object (for fluent API support)
     * @throws PropelException - if the value is not accepted by this enum.
     */
    public function setEstaVacunado($v)
    {
        if ($v !== null) {
            $valueSet = UsuariosPeer::getValueSet(UsuariosPeer::VACUNADO);
        ...
        if ($this->vacunado !== $v) {
            $this->vacunado = $v;
            $this->modifiedColumns[] = UsuariosPeer::VACUNADO;
        }
     ...
     * @throws PropelException - if the value is not accepted by this enum.
     */
    public function setQueGenero($v)
    {
        if ($v !== null) {
            $valueSet = UsuariosPeer::getValueSet(UsuariosPeer::GENERO);
            if (!in_array($v, $valueSet)) {
        ...
        if ($this->genero !== $v) {
            $this->genero = $v;
            $this->modifiedColumns[] = UsuariosPeer::GENERO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->vacunado = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->genero = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = UsuariosPeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->ventassScheduledForDeletion !== null) {
                if (!$this->ventassScheduledForDeletion->isEmpty()) {
                    VentasQuery::create()
                        ->filterByPrimaryKeys($this->ventassScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::NOMBRES)) {
            $modifiedColumns[':p' . $index++]  = '`nombres`';
        }
        if ($this->isColumnModified(UsuariosPeer::APELLIDOS)) {
            $modifiedColumns[':p' . $index++]  = '`apellidos`';
        }
        if ($this->isColumnModified(UsuariosPeer::CORREO)) {
            $modifiedColumns[':p' . $index++]  = '`correo`';
        }
        if ($this->isColumnModified(UsuariosPeer::TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = '`telefono`';
        }
        if ($this->isColumnModified(UsuariosPeer::VACUNADO)) {
            $modifiedColumns[':p' . $index++]  = '`vacunado`';
        }
        if ($this->isColumnModified(UsuariosPeer::GENERO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`telefono`':
                        ...
                        break;
                    case '`vacunado`':
                        $stmt->bindValue($identifier, $this->vacunado, PDO::PARAM_INT);
                        break;
                    case '`genero`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getEstaVacunado();
                break;
            case 6:
                return $this->getQueGenero();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getIdUsuarios(),
            $keys[1] => $this->getNombres(),
            $keys[2] => $this->getLosApellidos(),
            $keys[3] => $this->getCorreo(),
            $keys[4] => $this->getTelefono(),
            $keys[5] => $this->getEstaVacunado(),
            $keys[6] => $this->getQueGenero(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdUsuarios($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNombres($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setLosApellidos($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCorreo($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setTelefono($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setEstaVacunado($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setQueGenero($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::NOMBRES)) $criteria->add(UsuariosPeer::NOMBRES, $this->nombres);
        if ($this->isColumnModified(UsuariosPeer::APELLIDOS)) $criteria->add(UsuariosPeer::APELLIDOS, $this->apellidos);
        if ($this->isColumnModified(UsuariosPeer::CORREO)) $criteria->add(UsuariosPeer::CORREO, $this->correo);
        if ($this->isColumnModified(UsuariosPeer::TELEFONO)) $criteria->add(UsuariosPeer::TELEFONO, $this->telefono);
        if ($this->isColumnModified(UsuariosPeer::VACUNADO)) $criteria->add(UsuariosPeer::VACUNADO, $this->vacunado);
        if ($this->isColumnModified(UsuariosPeer::GENERO)) $criteria->add(UsuariosPeer::GENERO, $this->genero);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdUsuarios();
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLosApellidos($this->getLosApellidos());
        $copyObj->setCorreo($this->getCorreo());
        $copyObj->setTelefono($this->getTelefono());
        $copyObj->setEstaVacunado($this->getEstaVacunado());
        $copyObj->setQueGenero($this->getQueGenero());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdUsuarios(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     * If this Usuarios is new, it will return
    ...
    public function setVentass(PropelCollection $ventass, PropelPDO $con = null)
    {
        ...
        foreach ($ventassToDelete as $ventasRemoved) {
            $ventasRemoved->setUsuarioComprador(null);
        }
    ...
    protected function doAddVentas($ventas)
    {
        ...
        $ventas->setUsuarioComprador($this);
    }
    ...
    public function removeVentas($ventas)
    {
        if ($this->getVentass()->contains($ventas)) {
            ...
            $this->ventassScheduledForDeletion[]= clone $ventas;
            $ventas->setUsuarioComprador(null);
        }
